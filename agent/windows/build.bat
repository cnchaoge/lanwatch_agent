...
"%WORK_DIR%\venv312\Scripts\pip.exe" install --upgrade pip --disable-pip-version-check >nul 2>&1
"%WORK_DIR%\venv312\Scripts\pip.exe" install pystray pillow pyinstaller pywin32 -q --disable-pip-version-check
